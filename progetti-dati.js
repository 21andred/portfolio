...
const PROGETTI = [
...

  {
   ...
   
   {
    id: 'bottiglie',
    categoria: 'packaging-design',
    sommario: 'Progetto di packaging e comunicazione visiva per la linea di bottiglie termiche "WOW".',
    tag: [
      'Packaging',
      'Brand identity',
      'Render 3D'
   ...
   
  {
    id: 'friggitrice',
    categoria: 'packaging-design',
    sommario: 'Progetto di packaging e comunicazione visiva per la friggitrice "Benedetta Rossi".',
    tag: [
      'Packaging',
      'Brand identity',
      'Render 3D'
    ...
    id: 'iovino',
    categoria: 'packaging-design',
    sommario: 'Progetto di packaging e comunicazione visiva per la linea "IoVino".',
    tag: [
      'Packaging',
      'Brand identity',
      'Render 3D'
    ...
    id: 'blackdiamond',
    categoria: 'packaging-design',
    sommario: 'Progetto di packaging e comunicazione visiva per la linea Black Diamond.',
    tag: [
      'Packaging',
      'Brand identity',
      'Render 3D'
  ...
  },
 {
    id: 'cookingtherapy',
    categoria: 'packaging-design',
    sommario: 'Progetto di packaging e comunicazione visiva per la linea Cooking Therapy.',
    tag: [
      'Packaging',
      'Brand identity',
      'Render 3D'
